        ...
        <div className="container mx-auto px-4">
          <header className="max-w-3xl mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We provide advanced medical treatments with a focus on non-invasive and cosmetic health solutions. 
              All our services are performed by experienced practitioners in a safe environment.
            </p>
          </header>
